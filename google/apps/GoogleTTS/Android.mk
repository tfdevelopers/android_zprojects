...
ifeq ($(my_src_arch),arm)
  ...
  _googletts_lib_version_suffix := 210307121
else ifeq ($(my_src_arch),x86)
  LOCAL_SRC_FILES := $(LOCAL_MODULE)_x86.apk
  _googletts_lib_version_suffix := 210304061
endif
...
LOCAL_PREBUILT_JNI_LIBS := \
    ...
    @lib/$(my_src_abi)/libpatts_engine_jni_api_neon_ub.$(_googletts_lib_version_suffix).so
_googletts_lib_version_suffix :=
