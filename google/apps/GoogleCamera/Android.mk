...
LOCAL_PREBUILT_JNI_LIBS := \
    ...
    @lib/$(my_src_abi)/libzoom-prebuilt.so \
    @lib/$(my_src_abi)/libzoom-jni.so \
    @lib/$(my_src_abi)/libvision_face_jni.so \
    @lib/$(my_src_abi)/libsmartburst-jni.so \
    @lib/$(my_src_abi)/libRSSupportIO.so \
    @lib/$(my_src_abi)/librs.tinyplanet.so \
    @lib/$(my_src_abi)/libjni_yuvutil.so \
    @lib/$(my_src_abi)/libjni_faceutil.so \
    @lib/$(my_src_abi)/libjni_imgutil.so \
