...
public class DashboardContainerView extends ViewGroup {
	...
	if(res.getInteger(R.integer.dashboard_num_columns)==1){
                mNumColumns = Settings.System.getInt(context.getContentResolver(), android.provider.Settings.System.SETTINGS_COLUMNS, res.getInteger(R.integer.dashboard_num_columns));
                twoColumns=true;
        }else{
